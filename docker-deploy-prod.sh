...
then
  ...
  then
    ...
    deploy_cluster() {
      ...
      cluster="serpent-tracker-production-cluster"

      # api
      service="serpenttracker-api-prod-service"
      ...
      # client
      service="serpenttracker-client-prod-service"
      ...
      # swagger
      service="serpenttracker-swagger-prod-service"
